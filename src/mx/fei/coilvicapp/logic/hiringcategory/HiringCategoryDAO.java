...
public class HiringCategoryDAO implements IHiringCategory{
    ...
    public int registerHiringCategory(HiringCategory hiringCategory) throws DAOException {
        ...
        if (!checkNameDuplication(hiringCategory)) {
            result = insertHiringCategory(hiringCategory);
        }
        return result;        
    }
    ...
    public int updateHiringCategoryVerification(HiringCategory newHiringCategory) throws DAOException {   
        int result = 0;

        if (!checkNameDuplication(newHiringCategory)) {
            result = updateHiringCategory(newHiringCategory);
        }
        return result;          
    }    
