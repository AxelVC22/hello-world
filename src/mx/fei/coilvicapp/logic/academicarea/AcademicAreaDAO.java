...
public class AcademicAreaDAO implements IAcademicArea{
    ...
    public int registerAcademicArea(AcademicArea academicArea) throws DAOException {
        ...
        if (!checkNameDuplication(academicArea)) {
            result = insertAcademicArea(academicArea);
        }
        return result;        
    }
    ...
    public int updateAcademicAreaVerification(AcademicArea newAcademicAreaInformation) throws DAOException {   
        int result = 0;

        if (!checkNameDuplication(newAcademicAreaInformation)) {
            result = updateAcademicArea(newAcademicAreaInformation);
        }
        return result;          
    }
